# Style pack: utility  (v2 — deep re-teardown 2026-07-24)

> Renamed 2026-08-16 from `nick-saraev`. Tips and tools: designed artifacts,
> comment-gate CTA. Legacy ids (`nick-saraev`, `nick`) still resolve.
...
- google-15 (5 of Google's 15 free AI tools — Pomelli/Stitch/Opal/Antigravity/
  ...
  deviceframe scroll, word-reveal captions (ink on cream, amber keywords),
