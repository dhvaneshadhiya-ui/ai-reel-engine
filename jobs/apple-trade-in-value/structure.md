# Structure — apple-trade-in-value
...
A viewer who believes the $720 on Apple's trade-in page is what their old
iPhone is worth discovers that every figure on that page is a ceiling — the
same headline says $40 — which matters because they are about to trade a phone
...
Planted: the hook states the $720 and immediately says "read it again" —
...
WHAT: Apple's page lists iPhone 16 Pro Max at up to $720, and headlines the
range as $40–$720.
...
SO WHAT: budget against the quote, not the table — the gap between $720 and $40
...
Apple, https://www.apple.com/shop/trade-in — read from the LIVE DOM on
