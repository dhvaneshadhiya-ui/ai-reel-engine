# mac-multiple-headphones — packaging

Validated with `python3 tools/packaging_check.py mac-multiple-headphones`.
...
PINNED COMMENT: PairPods (free, open source, macOS 13.5+): https://pairpods.app
