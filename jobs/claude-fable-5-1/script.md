...
Here's what Anthropic buried further down that page, and it's the line that changes your bill.

First, the headline. On agentic science work, Fable 5.1 more than doubled its predecessor: twenty-four point seven percent, to fifty-two point six.
...
Now, the bottom of the page. It's the price of a cache read.
...
The Financial Times put Fable 5 near eleven percent of Anthropic spend. Their smartest model, and almost nobody left it running.

Meanwhile Mythos 5.1 is the same model on a looser leash: vetted US cyberdefence and life sciences only.

But every figure here is Anthropic's own, measured with its own safeguards on.
