...
BRIEF = (
    ...
    "`reel-builder`, ANY `marketing-skills:*` skill, `youtube-scriptwriting` or "
    "`technical-video-script` (they advise on WORDS, they never build), or the aaron-marketing "
    "plugin's `short-video-scripter` / `social-creative-builder` / "
    "`launch-asset-packager` / `/social` command take the job — the "
